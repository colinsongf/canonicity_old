...
#     (•ㅅ•) || 
#     / 　 づ
LABELS = ["Country", "Region", "City", "Institution", "Department", "Lab"] # The labels should be a list of strings

#***************** OPTIONAL CONFIG ***************************************************
PARENT_LABEL  = 'AffiliationString'               # the XML tag for each labeled string
GROUP_LABEL   = 'AffiliationCollection'                  # the XML tag for a group of strings
...
def tokenize(raw_string):
    ...
    re_tokens = re.compile( r"""\(*\b[^\s,;#&()]+[.,;)]*""", re.VERBOSE | re.UNICODE)
